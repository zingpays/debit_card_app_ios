...
struct _R {
  ...
  struct string {
    ...
    struct localizable {
      ...
      ///
      /// Locales: en, zh-Hans
      var authQrcodeTips: RswiftResources.StringResource { .init(key: "authQrcodeTips", tableName: "Localizable", source: source, developmentValue: "If you are unable to scan the QR code, please enter this code manually into the app.", comment: nil) }
      ...
      /// en translation: Click to verify Face ID
      ///
      /// Key: faceIDLoginSubTitle
      ///
      /// Locales: en, zh-Hans
      var faceIDLoginSubTitle: RswiftResources.StringResource { .init(key: "faceIDLoginSubTitle", tableName: "Localizable", source: source, developmentValue: "Click to verify Face ID", comment: nil) }

      /// en translation: Face ID Login
      ///
      /// Key: faceIdLogin
      ///
      /// Locales: en, zh-Hans
      ...
      ///
      /// Locales: en, zh-Hans
      var rejected: RswiftResources.StringResource { .init(key: "rejected", tableName: "Localizable", source: source, developmentValue: "Rejected", comment: nil) }
      ...
      /// en translation: Click to verify Touch ID
      ///
      /// Key: touchIDLoginSubTitle
      ///
      /// Locales: en, zh-Hans
      ...
      ///
      /// Locales: en, zh-Hans
      var touchIdLogin: RswiftResources.StringResource { .init(key: "touchIdLogin", tableName: "Localizable", source: source, developmentValue: "Touch ID Login", comment: nil) }
      ...
      ///
      /// Locales: en, zh-Hans
      var verificationInReview: RswiftResources.StringResource { .init(key: "verificationInReview", tableName: "Localizable", source: source, developmentValue: "Verification In Review", comment: nil) }
  ...
  struct image {
    ...
    /// Image `iconExactitudeLight`.
    var iconExactitudeLight: RswiftResources.ImageResource { .init(name: "iconExactitudeLight", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `iconFaceid`.
    var iconFaceid: RswiftResources.ImageResource { .init(name: "iconFaceid", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `iconRefreshCircle`.
    var iconRefreshCircle: RswiftResources.ImageResource { .init(name: "iconRefreshCircle", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `iconTouchid`.
    var iconTouchid: RswiftResources.ImageResource { .init(name: "iconTouchid", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
  ...
  struct nib {
    ...
    func validate() throws {
      ...
      if UIKit.UIImage(named: "iconRefreshCircle", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'iconRefreshCircle' is used in nib 'AuthSettingQRCodeViewController', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "iconDepositWhite", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'iconDepositWhite' is used in nib 'CryptoWalletCardView', but couldn't be loaded.") }
      if UIKit.UIImage(named: "iconWithdrawWhite", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'iconWithdrawWhite' is used in nib 'CryptoWalletCardView', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "fw#FAFAFA", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'fw#FAFAFA' is used in nib 'CryptoWalletCardView', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "bgDollarCircle", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'bgDollarCircle' is used in nib 'HomeOverviewTableViewCell', but couldn't be loaded.") }
      if UIKit.UIImage(named: "bgbitcoinCircle", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'bgbitcoinCircle' is used in nib 'HomeOverviewTableViewCell', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "iconExactitudeLight", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'iconExactitudeLight' is used in nib 'LanguageTableViewCell', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "fw#000000", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'fw#000000' is used in nib 'QuickUnlockViewController', but couldn't be loaded.") }
      ...
      if UIKit.UIColor(named: "fw#FFFFFF", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Color named 'fw#FFFFFF' is used in nib 'QuickUnlockViewController', but couldn't be loaded.") }
